...
EDGE_TYPE_COLORS_pos = {
    'q': "#005C99",  # dark blue
    'k': "#0072B2",  # base blue
    'v': "#66AED6",  # light blue
}

EDGE_TYPE_COLORS_neg = {
    'q': "#A94700",  # dark vermilion
    'k': "#D55E00",  # base vermilion
    'v': "#F1A642",  # light orange
}

def get_color(qkv: Optional[Literal['q','k','v']], score:float):
    if qkv is not None:
        if score >= 0:
            return EDGE_TYPE_COLORS_pos[qkv]
        else:
            return EDGE_TYPE_COLORS_neg[qkv]
    elif score < 0:
        return "#FF0000" # Red
    else:
        return "#000000" # Black
