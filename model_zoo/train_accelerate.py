...
import sys
sys.path.append('/usa/yxpengcs/PycharmProjects/vit-spurious-robustness/datasets')
sys.path.append('/usa/yxpengcs/PycharmProjects/vit-spurious-robustness-modified')
...
def main():
    ...
    if args.model_arch == "BiT":
        ...
        from train_vit_accelerate import train_model
        train_model(args)
