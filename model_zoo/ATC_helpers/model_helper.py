...
def get_net(net_name, data, num_classes=10, pretrained=False):
    change = True
    if net_name == "ResNet18":
        ...
        net = ConvNet()
    elif net_name == "FCN" and data == "MNIST":
    ...
    elif net_name == "DenseNet121" and data.startswith("CIFAR"):
    ...
    elif net_name == "AllConv":
        net = AllConv(num_classes=num_classes)

    elif (net_name == "DenseNet121") or (net_name == "DenseNet" and data.startswith("CIFAR")):
    ...
    elif net_name == "distilbert-base-uncased":
        net = initialize_bert_based_model(net, num_classes)

    if net_name in ('ResNet50', 'DenseNet', 'DenseNet121') and change:
